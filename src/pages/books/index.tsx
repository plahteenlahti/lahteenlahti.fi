  ...
  return (
    <Layout location={props.location} title={siteTitle}>
      ...
      <p>
        ...
        now and spent rest of my life reading in solitude. However, I haven't
        always liked books, I actually hated it. I learned to read at second
        grade (usually people learn to do that at first grade), after my mom
        caught on
      </p>
      <p>
