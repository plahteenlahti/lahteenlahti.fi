...
const Books = (props: Props) => {
  ...
  return (
    <Layout location={props.location} title={siteTitle}>
      <SEO
        slug='about'
        title='Lukemiani kirjoja '
        description=''
        keywords={[`blog`, `javascript`, `react`]}
      />
      <h1>Kirjoja joita olen lukenut</h1>
      <p>
        Luen melko paljon. Jos voisin valita, eläköityisin nyt ja viettäisin
        loppuelämäni yksin vain lukien kirjoja.
      </p>
      <p>
        Tässä lista lukemistani kirjoista. Toivottavasti siitä on sinulle
        hyötyä.
      </p>
